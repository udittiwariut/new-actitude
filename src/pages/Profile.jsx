      ...
      <option value="3">America</option>
        ...
        <div key={`inline-${type}`} className="mb-3">
          ...
          />
              ...
              <button onClick={signupHandler} className="signupbutton">Save changes</button>
              {/* <NavLink to="/login">Already registered? Login</NavLink> */}
              <br />
              <button className="cancelbutton">Discard Changes</button>
              <p className="deleteaccount">Delete my Account</p>
            </form>
          </div>
        </div>
      </div>
